...
class Proposal(JsonSerializable, db.Model):
    ...
    type         = db.Column(db.Enum(*schema.PROPOSAL_TYPES, name="proposal_types"), default='talk')
    expected_duration = db.Column(db.Numeric(scale=2), default=0)
    demands      = db.Column(db.Text, default='')
