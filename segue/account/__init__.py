...
class AccountBlueprint(flask.Blueprint):
    def __init__(self):
        ...
        self.add_url_rule('/<int:account_id>/certificate-name', methods=['POST'], view_func=self.controller.set_certificate_name)
        ...
        self.add_url_rule('/<int:account_id>/employees', methods=['GET'], view_func=self.controller.list_employees)
