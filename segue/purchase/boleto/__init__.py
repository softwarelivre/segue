...
from segue.purchase.boleto.models import BoletoTransition, BoletoPayment
...
class BoletoPaymentService(object):
    ...
    def get_by_our_number(self, our_number):
    ...
    def notify(self, purchase, payment, payload, source='notificationv'):
